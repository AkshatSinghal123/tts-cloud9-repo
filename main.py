...
app.add_middleware(
    CORSMiddleware,
    allow_origins=["http://fastap-appli-78x5learppwc-602530875.ap-northeast-3.elb.amazonaws.com/","http://localhost:8000/"],  # Allow these origins
...
S3_BUCKET_NAME = "text-to-speech-121263836368-ap-northeast-3"  # Replace with your S3 bucket name
...
def get_azure_secrets(secret_name="azure-secrets", region_name="ap-south-1"):
    try:
        ...
        role_arn = "arn:aws:iam::121263836368:role/fastapi-deployment-TaskExecutionRole-J95E5B1WBwBk"  # Replace with your IAM role ARN
